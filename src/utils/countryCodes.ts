...
export const COUNTRY_CODES: CountryCode[] = [
    ...
    { code: 'VG', dial_code: '+1284', name: 'British Virgin Islands' },
    ...
    { code: 'CI', dial_code: '+225', name: "Côte d'Ivoire" },
    ...
    { code: 'IN', dial_code: '+91', name: 'India' }, // 🇮🇳 Default Country Code
...
/**
 * Finds the default country code for India (+91)
 */
export const DEFAULT_COUNTRY_CODE: CountryCode = COUNTRY_CODES.find(c => c.code === 'IN') || { code: 'IN', dial_code: '+91', name: 'India' };